package com.jbit.design.combination;
...
import com.jbit.design.combination.service.engine.IEngine;
import com.jbit.design.combination.service.engine.impl.TreeEngineHandle;
...
public class CombinationTest {
    private Logger log= Logger.getLogger(CombinationTest.class.getName());
    ...
    public void init(){
        ...
        treeNodeLinkList_01.add(treeNodeLink_12);
        treeNodeLinkList_01.add(treeNodeLink_11);
        treeNode_01.setTreeNodeLinkList(treeNodeLinkList_01);
        ...
        treeNodeLink_122.setNodeIdTo(121L);
